...
- 💪 **Safe** - Built-in validation with **[zod](zod)**, **[valibot](valibot)** or **[arktype](arktype)**. _Full list [here](https://github.com/standard-schema/standard-schema?tab=readme-ov-file#what-schema-libraries-implement-the-spec)_
