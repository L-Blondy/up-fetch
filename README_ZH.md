...
- [亮点](#%E2%9E%A1%EF%B8%8F-亮点)
- [快速开始](#%E2%9E%A1%EF%B8%8F-快速开始)
- [主要特性](#%E2%9E%A1%EF%B8%8F-主要特性)
   - [请求配置](#%E2%9C%94%EF%B8%8F-请求配置)
   - [简单查询参数](#%E2%9C%94%EF%B8%8F-简单查询参数)
   - [自动处理请求体](#%E2%9C%94%EF%B8%8F-自动处理请求体)
   - [模式验证](#%E2%9C%94%EF%B8%8F-模式验证)
   - [生命周期钩子](#%E2%9C%94%EF%B8%8F-生命周期钩子)
   - [超时设置](#%E2%9C%94%EF%B8%8F-超时设置)
   - [错误处理](#%E2%9C%94%EF%B8%8F-错误处理)
- [使用方法](#%E2%9E%A1%EF%B8%8F-使用方法)
   - [身份验证](#%E2%9C%94%EF%B8%8F-身份验证)
   - [删除默认选项](#%E2%9C%94%EF%B8%8F-删除默认选项)
   - [表单数据](#%E2%9C%94%EF%B8%8F-表单数据)
   - [HTTP 代理](#%E2%9C%94%EF%B8%8F-http-代理)
   - [多个 fetch 客户端](#%E2%9C%94%EF%B8%8F-多个-fetch-客户端)
- [高级用法](#%E2%9E%A1%EF%B8%8F-高级用法)
   - [错误作为值](#%E2%9C%94%EF%B8%8F-错误作为值)
   - [自定义响应解析](#%E2%9C%94%EF%B8%8F-自定义响应解析)
   - [自定义响应错误](#%E2%9C%94%EF%B8%8F-自定义响应错误)
   - [自定义参数序列化](#%E2%9C%94%EF%B8%8F-自定义参数序列化)
   - [自定义请求体序列化](#%E2%9C%94%EF%B8%8F-自定义请求体序列化)
   - [基于请求的默认值](#%E2%9C%94%EF%B8%8F-基于请求的默认值)
- [API 参考](#%E2%9E%A1%EF%B8%8F-api-参考)
- [功能比较](#%E2%9E%A1%EF%B8%8F-功能比较)
- [环境支持](#%E2%9E%A1%EF%B8%8F-环境支持)
...
[api-reference]: #%E2%9E%A1%EF%B8%8F-api-参考
