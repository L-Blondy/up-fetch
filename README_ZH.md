...
- [亮点](#️%EF%B8%8F-亮点)
- [快速开始](#️%EF%B8%8F-快速开始)
- [主要特性](#️%EF%B8%8F-主要特性)
   - [请求配置](#️%EF%B8%8F-请求配置)
   - [简单查询参数](#️%EF%B8%8F-简单查询参数)
   - [自动处理请求体](#️%EF%B8%8F-自动处理请求体)
   - [模式验证](#️%EF%B8%8F-模式验证)
   - [生命周期钩子](#️%EF%B8%8F-生命周期钩子)
   - [超时设置](#️%EF%B8%8F-超时设置)
   - [错误处理](#️%EF%B8%8F-错误处理)
- [使用方法](#️%EF%B8%8F-使用方法)
   - [身份验证](#️%EF%B8%8F-身份验证)
   - [删除默认选项](#️%EF%B8%8F-删除默认选项)
   - [表单数据](#️%EF%B8%8F-表单数据)
   - [HTTP 代理](#️%EF%B8%8F-http-代理)
   - [多个 fetch 客户端](#%EF%B8%8F-多个-fetch-客户端)
- [高级用法](#️%EF%B8%8F-高级用法)
   - [错误作为值](#️%EF%B8%8F-错误作为值)
   - [自定义响应解析](#️%EF%B8%8F-自定义响应解析)
   - [自定义响应错误](#️%EF%B8%8F-自定义响应错误)
   - [自定义参数序列化](#️%EF%B8%8F-自定义参数序列化)
   - [自定义请求体序列化](#️%EF%B8%8F-自定义请求体序列化)
   - [基于请求的默认值](#️%EF%B8%8F-基于请求的默认值)
- [API 参考](#️%EF%B8%8F-api-参考)
- [功能比较](#️%EF%B8%8F-功能比较)
- [环境支持](#️%EF%B8%8F-环境支持)
